...
public class LikeScrapList {
	...
	public LikeScrapList() {
		// TODO Auto-generated constructor stub
	}

	public LikeScrapList(int reviewNo, int reviewRating, int recommend, int repurcharse, int spicy, int sweet,
			int bitter, int salty, int sour, String good, String bad, Date createDate, Date modifyDate, int likeCount,
			int productNo, String emailId, String reviewStatus, String nickName, String productName, String flavor1,
			String flavor2, String flavor3, int likeNo) {
		super();
	...
	public String toString() {
		return "LikeScrapList [reviewNo=" + reviewNo + ", reviewRating=" + reviewRating + ", recommend=" + recommend
