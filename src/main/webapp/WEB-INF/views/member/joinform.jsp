 ...
 <!-- <div class="uk-position-center">  -->
	...
	<div class ="uk-align-center">
		...
		<hr class = "hr1">
	 	...
	 	<form action="join.me" onsubmit = "return insertValidate();" >
	    ...
	    <div class="uk-inline">
		        ...
		        <div class="uk-margin">
		            	...
		            	<input class="uk-input" id="email" name="email"  type="text" placeholder="이메일 형식으로 입력해주세요" style = "height:44px;width:300px;text-align:left;padding-left:10px;" required>
	    ...
	    <div class="uk-margin-small">
	        <div class="uk-inline"> 
	             ...
	             <input class ="uk-input nickname" name = "nickName" type="text" placeholder="닉네임을 입력해주세요" style = "height:44px;width:300px;text-align:left;" required>
	        </div>
	    </div>
