...
<body>
	...
	<div class="uk-container uk-container-small">
		<h3 class="uk-heading-bullet">내가 좋아요한 리뷰 보기</h3>
		<div class="uk-overflow-auto">
			<table class="uk-table uk-table-middle uk-table-divider">
		        ...
		        <tbody>
					...
					<tr class="contentTr">
						<td>
							<c:forEach var="img" items="${ scrapReviewImageList }" begin="0" end="1">
						...
						<td>
							...
							<div>${ r.good }</div>
							<div>${ r.bad }</div>
							<c:url var="ldelete" value="deleteLikeScrap.me">
								<c:param name="lNo" value="${ r.likeNo }"/>
							</c:url>
						</td>
						<td><a href="${ ldelete }" uk-icon="trash" style="width: 50px"></a></td>
					</tr>
					</c:forEach>
					</c:if>
					...
					<c:if test="${ empty list }">
					<tr>
						<td colspan="3" style="text-align: center;">좋아요한 리뷰가 존재하지 않습니다.</td>
					</tr>
					</c:if>
				</tbody>
				<tfoot>
