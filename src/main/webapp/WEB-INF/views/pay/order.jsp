...
<!-- CSS Link  -->
<link href="../../../Trend_Eater/resources/css/pay/order.css" rel="stylesheet">
<!-- JQuery 최신버젼 CDN 링크  -->
...
<body>
    ...
    <div id="main">
        ...
        <div id="itemList" class="page_aticle order_goodslist"><div class="info_product"><a class="btn" href="#none"><span class="screen_out">펼침 / 닫힘</span></a>
          ...
          <form id="form" name="frmOrder" action="pay.pa" method="post" onsubmit="return validateOrderForm(this)" class="order_view" novalidate="">
        ...
        <input type="submit" value="130,000원 결제하기" class="btn_payment">
