...
<link rel="stylesheet" type="text/css" href="${ pageContext.servletContext.contextPath }/resources/css/board/boardQnaUpdateForm.css">
...
<div class="main">
   <form action="boardQnaUpdateForm.bo" method="post">
	    ...
	    <div class="submitButton">
	        ...
	        <button type="button" onclick="location.href='boardQna.bo'">목록으로</button> <!-- 3번페이지면 3번으로 돌아갈 수 있게 page-->
